...
def get_events_by_calendarId(service, calendarId, timeMin, timeMax, allEvents):
    ...
    list
    """
    events_result = service.events().list(calendarId= bmNsZXZlbGFuZDE5ODRAZ21haWwuY29t
                                        , timeMin=timeMin
                                        , timeMax=timeMax
                                        , singleEvents=True
...
def get_recipes(service, spreadsheetId, range):
    ...
    """
    recipes_result = service.spreadsheets().values().get(spreadsheetId= '1pbbDcpYE9VCV64-T95QkKpLwZrStxP1PuC93H3UZ9X8', range='recepten!A:G').execute()
...
if __name__ == '__main__':
    ...
    CREDS_PATH = "C:\Users\nclev\Downloads\meal-planner-and-shopping-list-4064e3a3c22f.json"
